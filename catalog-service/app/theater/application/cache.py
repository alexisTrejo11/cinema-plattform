...
def cache_theater_by_id(
    expire: int = 3600,
) -> Callable[..., Callable[..., Awaitable[Optional[Theater]]]]:
    """
    ...
    def decorator(
        func: Callable[..., Awaitable[Optional[Theater]]],
    ) -> Callable[..., Awaitable[Optional[Theater]]]:
        @wraps(func)
        async def wrapper(
            self, theater_id: int, *args: Any, **kwargs: Any
        ) -> Optional[Theater]:
...
def cache_theaters_by_cinema(
    expire: int = 3600,
) -> Callable[..., Callable[..., Awaitable[List[Theater]]]]:
    """
    ...
    def decorator(
        func: Callable[..., Awaitable[List[Theater]]],
    ) -> Callable[..., Awaitable[List[Theater]]]:
        @wraps(func)
        async def wrapper(
            self, cinema_id: int, *args: Any, **kwargs: Any
        ) -> List[Theater]:
            if not _is_cache_available():
...
def cache_theaters_list(
    ...
    def decorator(
        ...
        @wraps(func)
        async def wrapper(
            self, page_params: Dict[str, Any], *args: Any, **kwargs: Any
        ) -> List[Theater]:
            if not _is_cache_available():
...
def cache_seat_by_id(
    expire: int = 3600,
) -> Callable[..., Callable[..., Awaitable[TheaterSeat]]]:
    """
    ...
    def decorator(
        func: Callable[..., Awaitable[TheaterSeat]],
    ) -> Callable[..., Awaitable[TheaterSeat]]:
        @wraps(func)
...
def cache_seats_by_theater(
    expire: int = 1800,
) -> Callable[..., Callable[..., Awaitable[List[TheaterSeat]]]]:
    """
    ...
    def decorator(
        func: Callable[..., Awaitable[List[TheaterSeat]]],
    ) -> Callable[..., Awaitable[List[TheaterSeat]]]:
        @wraps(func)
        async def wrapper(
            self, theater_id: int, *args: Any, **kwargs: Any
        ) -> List[TheaterSeat]:
