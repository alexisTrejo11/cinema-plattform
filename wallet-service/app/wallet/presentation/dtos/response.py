...
class WalletResponse(BaseModel):
    ...
    transactions: Optional[List[WalletTransactionResponse]] = Field(
        [],
...
class BuyCreditResponse(BaseModel):
    ...
    balance: Decimal = Field( # Note: This is Decimal, while WalletResponse.balance is MoneyResponse. Be consistent.
        ...,
...
class PayResponse(BaseModel):
    ...
    amount: float = Field( # Note: It's often better to use Decimal for financial amounts to avoid float precision issues.
        ...,
        gt=0,
    ...
    model_config = ConfigDict(from_attributes=True) # Ensure this is also Pydantic v2 config