...
class WalletUseCases:
    ...
    def __init__(
        ...
        # Both query use-cases need the transaction repo to optionally load transactions
        self._get_wallet_by_id = GetWalletByIdUseCase(wallet_repo, transaction_repository)
        self._get_wallets_by_user_id = GetWalletsByUserIdUseCase(wallet_repo, transaction_repository)
