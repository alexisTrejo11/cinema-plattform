-- ENUMS
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'showtime_type_enum') THEN
...
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'showtime_language_enum') THEN
...
CREATE INDEX IF NOT EXISTS idx_showtimes_theater_time ON showtimes (theater_id, start_time);
