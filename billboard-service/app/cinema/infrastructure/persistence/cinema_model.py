...
class CinemaModel(Base):
    ...
    # Enums
    type: Mapped[CinemaType] = mapped_column(SQLEnum(CinemaType, name='cinema_type_enum', create_type=False), nullable=False)
    status: Mapped[CinemaStatus] = mapped_column(SQLEnum(CinemaStatus, name='cinema_status_enum', create_type=False), nullable=False)
    region: Mapped[LocationRegion] = mapped_column(SQLEnum(LocationRegion, name='location_region_enum', create_type=False), nullable=False)
