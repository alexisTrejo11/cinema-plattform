...
class SeatValidationService:
    ...
    async def validate_not_duplicated_seat(self, theater_id: int, seat_row: str, seat_number: int):
            is_seat_duplicated = await self.seat_repository.exist_by_theater_and_seat_values(
