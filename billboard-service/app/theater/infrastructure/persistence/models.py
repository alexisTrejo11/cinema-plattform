...
from sqlalchemy import String, Integer, Boolean, DateTime, ForeignKey, Enum as SqlEnum, UniqueConstraint
...
if TYPE_CHECKING:
    from app.showtime.infrastructure.persistence.models import ShowtimeSeatModel
...
class TheaterSeatModel(Base):
    ...
    seat_type: Mapped[SeatType]  = mapped_column(SqlEnum(SeatType, name='seat_type_enum', create_type=False), nullable=False, default=SeatType.STANDARD)
...
class TheaterModel(Base):
    ...
    theater_type: Mapped[TheaterType] = mapped_column(SqlEnum(TheaterType, name="theater_type_enum", create_type=False), nullable=False)
