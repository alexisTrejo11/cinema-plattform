...
from app.showtime.domain.entities.showtime_seat import ShowtimeSeatBase
from app.shared.core.pagination import PaginationMetadata, Page
...
class PaginatedShowtimeResponse(PaginationMetadata):
