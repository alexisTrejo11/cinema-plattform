...
class ShowtimeModelMapper:
    """
    Mapp. class to convert between ShowtimeEntity (domain),
    ...
    def from_domain(entity: Showtime) -> ShowtimeModel:
        ...
        and are not directly mapp. to the database model.
        """
    ...
    def from_update_dto(dto: ShowtimeUpdate) -> Dict[str, Any]:
        ...
        This dictionary can then be app.ed to an existing ShowtimeModel instance.
        """
