...
class IntegrationEvent(Protocol):
    ...
    Domain event classes can implement this structurally.
    This protocol remains framework-agnostic for any bounded context.
    """
...
class DomainEvent(BaseModel, ABC):
    """Base class for integration-ready domain events."""
