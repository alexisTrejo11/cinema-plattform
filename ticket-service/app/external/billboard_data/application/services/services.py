...
from app.external.billboard_data.domain.entities.cinema import Cinema, Theater
from app.external.billboard_data.domain.entities.theather_seat import TheaterSeat
