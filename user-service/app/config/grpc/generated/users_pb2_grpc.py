...
class UsersServiceStub(object):
    """Internal user lookup between microservices. Password and TOTP secrets are never exposed.
    ...
    def __init__(self, channel):
        ...
        self.GetUserById = channel.unary_unary(
                '/users.UsersService/GetUserById',
        ...
        self.GetUserByEmail = channel.unary_unary(
                '/users.UsersService/GetUserByEmail',
                request_serializer=users__pb2.GetUserByEmailRequest.SerializeToString,
                response_deserializer=users__pb2.GetUserResponse.FromString,
                _registered_method=True)
        self.GetUserByPhone = channel.unary_unary(
                '/users.UsersService/GetUserByPhone',
                request_serializer=users__pb2.GetUserByPhoneRequest.SerializeToString,
                response_deserializer=users__pb2.GetUserResponse.FromString,
                _registered_method=True)
...
def add_UsersServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetUserByPhone': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=users__pb2.GetUserByPhoneRequest.FromString,
                    response_serializer=users__pb2.GetUserResponse.SerializeToString,
            ),
    }
...
class UsersService(object):
    ...
    def GetUserByPhone(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/users.UsersService/GetUserByPhone',
            users__pb2.GetUserByPhoneRequest.SerializeToString,
            users__pb2.GetUserResponse.FromString,
            options,
            channel_credentials,
            insecure,
