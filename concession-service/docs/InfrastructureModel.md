...
- **Components** (`DeploymentComponent[]`):
  - **Component 1**
    ...
    - **Icon**: "monitor"
    - **Description**: "End-user clients accessing the concession service through REST API"
  - **Component 2**
...
- **Components** (`DeploymentComponent[]`):
  - **Component 1**
    ...
    - **Icon**: "package"
    - **Description**: "3 uvicorn workers running the concession service REST API"
  - **Component 2**
    - **Name**: "gRPC Server"
    - **Icon**: "zap"
...
- **Components** (`DeploymentComponent[]`):
  - **Component 1**
    - **Name**: "PostgreSQL 16"
    - **Icon**: "database"
    - **Description**: "Primary relational database for products, combos, promotions, and categories"
  - **Component 2**
    - **Name**: "Redis 7 Alpine"
    - **Icon**: "hard-drive"
...
- **Content**:
  ...
  server {
      ...
      location / {
          proxy_pass http://concession_backend;
...
- **Purpose**: "Primary relational database for all concession service data"
- **Icon**: "database"
...
- **Value**: "60s"
- **Icon**: "clock"
- **Description**: "Default Redis cache expiration time"
